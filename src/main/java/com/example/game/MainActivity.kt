...
class MainActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        newgame.setOnClickListener {
            ...
            val randomX =
                random.nextInt(500) - 400 // generate a random x-coordinate between -400 and 400
            val randomY =
                random.nextInt(500) - 400 // generate a random y-coordinate between -400 and 400
            ...
            val runnable = object : Runnable {
                override fun run() {
                    ...
                    when (currentDirection) {
                        "up" -> {
                            snakeY -= 5 //Calculate the speed of the snake
                        ...
                        "left" -> {
                            snakeX -= 5 //Calculate the speed of the snake
                            if (snakeX < -370) { // Check if the ImageView goes off the top of the board
                                snakeX = -370f
                                border.setBackgroundColor(getResources().getColor(R.color.red))
                                playagain.visibility = View.VISIBLE
                                currentDirection = "pause"
